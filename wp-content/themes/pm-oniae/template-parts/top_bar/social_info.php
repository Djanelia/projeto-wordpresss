...
<div class="topbar_info_data">
	<div class="header_topbar_info">
		<div class="header_contact_data">
			<?php if(!empty(get_theme_mod( 'pm_oniae_contact_info_number','044632353231111' ))){ ?>
				<div class="contact_info">
					<i class="fa fa-phone"></i>
					<p><?php echo esc_html(get_theme_mod( 'pm_oniae_contact_info_number','044632353231111' )); ?></p>
				</div>
			<?php } 
			if(!empty(get_theme_mod( 'pm_oniae_email_info','3235323@gmail.com' ))){ ?> 
				<div class="email_info">
					<i class="fa fa-envelope"></i>
					<p><?php echo esc_html(get_theme_mod( 'pm_oniae_email_info','3235323@gmail.com' )); ?></p>
				</div>
			<?php } ?>
		</div>		
	</div>
