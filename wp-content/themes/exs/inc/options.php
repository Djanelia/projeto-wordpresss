...
if ( ! function_exists( 'exs_get_root_colors_inline_styles_string' ) ) :
	function exs_get_root_colors_inline_styles_string() {
		...
		// colorMain
		// colorMain2
		$exs_css_vars_string .= exs_option( 'colorLight', '' ) ? '--colorLight:' . sanitize_hex_color( exs_option( 'colorLight', '' ) ) . ';' : '';
		$exs_css_vars_string .= exs_option( 'colorLight', '' ) ? '--colorLightRGB:' . exs_get_rgb_from_hex( sanitize_hex_color( exs_option( 'colorLight', '' ) ) ) . ';' : '';
		$exs_css_vars_string .= exs_option( 'colorFont', '' ) ? '--colorFont:' . sanitize_hex_color( exs_option( 'colorFont', '' ) ) . ';' : '';
		$exs_css_vars_string .= exs_option( 'colorFontMuted', '' ) ? '--colorFontMuted:' . sanitize_hex_color( exs_option( 'colorFontMuted', '' ) ) . ';' : '';
		$exs_css_vars_string .= exs_option( 'colorBackground', '' ) ? '--colorBackground:' . sanitize_hex_color( exs_option( 'colorBackground', '' ) ) . ';' : '';
		$exs_css_vars_string .= exs_option( 'colorBorder', '' ) ? '--colorBorder:' . sanitize_hex_color( exs_option( 'colorBorder', '' ) ) . ';' : '';
		$exs_css_vars_string .= exs_option( 'colorDark', '' ) ? '--colorDark:' . sanitize_hex_color( exs_option( 'colorDark', '' ) ) . ';' : '';
		$exs_css_vars_string .= exs_option( 'colorDarkMuted', '' ) ? '--colorDarkMuted:' . sanitize_hex_color( exs_option( 'colorDarkMuted', '' ) ) . ';' : '';
