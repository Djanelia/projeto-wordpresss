	...
	function exs_register_theme_block_patterns() {
		...
		$exs_patterns = apply_filters(
			...
			array(
				...
				'exs/media-right-side-icons'             => array(
					'title'       => esc_html__( 'Media with right image', 'exs' ),
